...
#include "../ListLib/SinglyLinkedListLib.h"
...
namespace ListTests
{
    TEST_CLASS(SinglyLinkedListIntTests)
    {
    public:
        ...
        {
            // Arrange
            SinglyLinkedList<int> list = { 10, 20, 30, 40, 50 };
        ...
        {
            // Arrange
            SinglyLinkedList<int> source = { 5, 10, 15 };
        ...
        {
            // Arrange
            SinglyLinkedList<int> original = { 7, 8, 9 };
            SinglyLinkedList<int> target;
        ...
        {
            // Arrange
            SinglyLinkedList<int> list = { 10, 30, 40 };
        ...
        {
            // Arrange
            SinglyLinkedList<int> list = { 5, 10, 15, 10, 20 };
        ...
        {
            // Arrange
            SinglyLinkedList<int> list = { 100, 200, 300, 400 };
        ...
        {
            // Arrange
            SinglyLinkedList<int> list = { 100, 200, 300 };
        ...
        {
            // Arrange
            SinglyLinkedList<int> list = { 5, 6, 7, 8 };
